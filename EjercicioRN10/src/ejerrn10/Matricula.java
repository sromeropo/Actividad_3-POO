...
public class Matricula extends javax.swing.JFrame {
    ...
    public void setDatos(int NI, String nombre, String apellido, double pagoMatricula){
        this.NI=NI;
        this.nombre = nombre;
        this.apellido = apellido;
        this.pagoMatricula = pagoMatricula;
        jLabel6.setText(Integer.toString(NI));
        jLabel7.setText(nombre);
        jLabel8.setText(apellido);
        jLabel9.setText(Double.toString(pagoMatricula));
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Nro Incripcion:");
