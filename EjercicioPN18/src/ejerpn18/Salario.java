...
public class Salario extends javax.swing.JFrame {
    ...
    public void setDatos(int ID, String nombre, String apellido, double salarioBruto, double salarioNeto){
        this.ID=ID;
        this.nombre = nombre;
        this.apellido = apellido;
        this.salarioBruto = salarioBruto;
        this.salarioNeto = salarioNeto;
        jLabel6.setText(Integer.toString(ID));
        jLabel8.setText(nombre);
        jLabel9.setText(apellido);
        jLabel10.setText(Double.toString(salarioBruto));
        jLabel11.setText(Double.toString(salarioNeto));
    }
